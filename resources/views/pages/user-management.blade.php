                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-3 py-1" id="chefProfile" data-toggle="modal" data-target="#myModal">
                                            <div>
                                                <img src="{{ asset('storage/profile_pictures/' . $chef->profile_picture) }}" class="avatar me-3" alt="image">
                                            </div>
                                    ...
                                    <td class="align-middle text-center">
                                        <form id="update-status-form" action="{{ url('/chef/verify', $chef->id) }}" method="POST">
                                            ...
                                            <select id="status" class="form-control" name="status">
                                                ...
                                                <option dislabled value="" {{ $chef->chefInfo->verified_by_admin == 0 ? 'selected' : '' }}>Pending</option>
                                                <option value="approved" {{ $chef->chefInfo->verified_by_admin == 1 ? 'selected' : '' }}>Verified</option>
                                            </select>
