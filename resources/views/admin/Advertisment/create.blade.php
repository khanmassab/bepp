...
@section('content')
    @include('layouts1.navbars.auth.topnav', ['title' => 'Create Advertisment'])
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">{{__('Create Advertisment')}} </p>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" accept="video/mp4,video/x-m4v,video/*,audio/mp3,audio/*" name="media" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="example-text-input" class="form-control-label">{{__('Video Link')}}</label>
                                        <input class="form-control" type="url" name="video_link" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
